<template>
  <section id="partner">
        ...
        <a href="#info"><div id="btn" >
         <button class="partner_button"  @click="text()" >Tell me more</button>
        </div></a>
      
        <div class="partner">
      
          <div class="partners">
            <img src="../assets/deezer.png" alt="deezer logo" />
          </div>
          <div class="partners">
...
.partner_button{
  ...
  transition-delay: 0s;
  animation: push 400ms linear 300ms; 
  background-color: gray; 
